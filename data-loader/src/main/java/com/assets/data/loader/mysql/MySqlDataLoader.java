package com.assets.data.loader.mysql;

import com.assets.data.loader.DataLoader;
import com.assets.data.loader.mysql.entities.Tables;
...
public class MySqlDataLoader implements DataLoader {
    ...
    public MySqlDataLoader(DataLoader defaultLoader, Connection connection) {
