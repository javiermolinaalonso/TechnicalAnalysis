...
public class PutOption extends Option {
    ...
    public PutOption(String ticker, double currentPrice, double strikePrice, LocalDate now, LocalDate expirationDate, double volatility, double riskFree) {
    ...
    public PutOption(String ticker, BigDecimal currentPrice, BigDecimal strikePrice, BigDecimal premium, LocalDate now, LocalDate expirationDate, Double riskFree) {
        super(ticker, currentPrice, strikePrice, premium, premium, OptionType.PUT, now, expirationDate, riskFree);
    }
